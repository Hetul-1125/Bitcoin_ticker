...
import 'package:bitcoin_ticker/price.dart';
...
class PriceScreenState extends State<PriceScreen> {
  ...
  // Networking networking=Networking("https://rest.coinapi.io/v1/exchangerate/BTC/USD?apiKey=B01FA982-FF1D-4513-8BD2-FB8B1ED03D3F");
  double? check;
  var selectCurrency = 'USD';

  updateui(dynamic bitcoin)
  {
